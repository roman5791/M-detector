...
def generate_launch_description():
    ...
    # config YAML path in package share
    avia_config = PathJoinSubstitution([FindPackageShare('m_detector'), 'config', 'avia', 'avia0.yaml'])
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            prefix=prefix,
            parameters=[
                # load YAML first, then override with command-line args (if provided)
                avia_config,
                {
